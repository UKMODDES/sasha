...
class DrawCirclesSpotFunction(BaseSpotFunction):
    ...
    def draw_circle(hand_start_x, hand_start_y):
    ...
    def execute(self, options: Namespace):
        ...
        draw_circle(starting_x, starting_y)
        
        #Draw top middle circle
        draw_circle(starting_x, starting_y-0.14)
        
        #Draw top right circle
        draw_circle(starting_x, starting_y-0.28)
        
        #Draw bottom left circle
        draw_circle(starting_x-0.07, starting_y-0.07)
        
        #Draw bottom right circle
        draw_circle(starting_x-0.07, starting_y-0.14)
